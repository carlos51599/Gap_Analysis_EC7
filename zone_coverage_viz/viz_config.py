...
- Frozen dataclasses for configuration (immutable)
- from_dict() methods for loading from dictionaries
...
# Default configuration - orchestrators access this, extract primitives
VIZ_CONFIG: VizConfig = VizConfig.defaults()
